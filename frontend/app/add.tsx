...
export default function AddScreen() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setErrorMessage('Błąd podczas zapisu aktywności');
            setModalVisible(true);
        } finally {
            setSaving(false);
        }
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={styles.container}>
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={{ borderWidth: 1, borderColor: '#ccc', borderRadius: 4, marginBottom: 20, backgroundColor: '#fff', overflow: 'hidden' }}>
                          <Picker
                            selectedValue={mood}
